...
game.onclick = function () {
    window.open('https://piicareta.github.io/guessing.game/')
}

login.onclick = function () {
    window.open('https://piicareta.github.io/tela.de.login/')
}
...
button.onclick = function () {
    window.open('https://github.com/Piicareta?tab=repositories')
}